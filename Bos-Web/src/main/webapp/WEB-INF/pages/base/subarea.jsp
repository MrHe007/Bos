...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#btn").click(function(){
			...
			var formJson = $("#searchForm").serializeJson(); 		// 得到表单中所有字段的 name- vlaue -》json 格式
			
			console.log(formJson);
			
			$('#grid').datagrid('load',formJson);		// 重新发送请求，但是不刷新页面
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="saveForm" action="${pageContext.request.contextPath }/subareaAction_saveSubarea">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							...
    							url:'${pageContext.request.contextPath }/regionAction_listAjax',
    							mode:'remote'" />  
						</td>
					</tr>
					<tr>
