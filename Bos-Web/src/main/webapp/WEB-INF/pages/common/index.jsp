...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			var flag = $("#validatePassForm").form('validate');
			...
			if(flag){	 // 如果验证通过
				...
				if( newPass != rePass ){
					...
					$.post(url,{'password':rePass},function(data){
    ...
    <div id="editPwdWindow" class="easyui-window" title="修改密码" collapsible="false" minimizable="false" modal="true" closed="true" resizable="false"
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                ...
                <from id="validatePassForm">
	                <table cellpadding=3>
	                 
	                    <tr>
	                        <td>新密码：</td>
	                        <td>
	                        	<input id="txtNewPass" type="Password" required='true' data-options="validType:'length[4,6]'"  class="txt01 easyui-validatebox" />
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
	                        <td>
	                      	  <input id="txtRePass" type="Password" required='true' data-options="validateType:'length[4,6]'" class="txt01 easyui-validatebox" />
	                        </td>
	                    </tr>
	                </table>
                </from>
